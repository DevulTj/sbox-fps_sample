...
public struct GravitationalMoveHelper
{
	...
	/// </example>
	public GravitationalMoveHelper( Vector3 position, Vector3 velocity, Vector3 down, params string[] solidTags ) : this()
	{
		Velocity = velocity;
		Position = position;
		GroundBounce = 0.0f;
	...
	/// var move = new MoveHelper( Position, Velocity )
	/// </example>
	public GravitationalMoveHelper( Vector3 position, Vector3 velocity, Vector3 down ) : this( position, velocity,  down,"solid", "playerclip", "passbullets", "player" )
	{
